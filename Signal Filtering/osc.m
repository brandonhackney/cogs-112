...
% [wave, xaxis] = osc(duration, frequency, amplidute, sample rate)
%
...
% 4. Sample rate in kHz (default 8 kHz; anything > 48kHz or < 1 Hz produces a warning)
%
